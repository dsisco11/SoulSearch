...
FRAMES = {
    ...
    add_race={l=FILTER_LEFT, t=6, w=25, h=1},
    clear_filters={l=FILTER_LEFT, t=7, w=20, h=1},
    presets={l=FILTER_LEFT, t=8, w=25, h=1},
    filter_list={l=FILTER_LEFT, t=10, w=FILTER_WIDTH, b=0},
