...
describe('unit scope filter provider', function()

    it('unit scope filter provider: applies the shared include and exclude algebra', function()
        ...
        assert.are.same({2}, ids(provider.get_units()))
    end)
