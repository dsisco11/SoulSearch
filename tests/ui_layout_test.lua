...
return function(test, repo_root)
    ...
    test.case('UI layout: stats header boundaries are exact', function()
        ...
        test.assert_equal('label', stats_layout.get_header_column(23, 0))
        test.assert_nil(stats_layout.get_header_column(24, 0))
        test.assert_nil(stats_layout.get_header_column(26, 0))
        test.assert_equal('value', stats_layout.get_header_column(27, 0))
        test.assert_equal('value', stats_layout.get_header_column(33, 0))
        test.assert_nil(stats_layout.get_header_column(34, 0))
    ...
    test.case('UI layout: stats delta cells use the scrolling records', function()
        test.assert_true(stats_layout.is_value_cell(27, 0))
        test.assert_true(stats_layout.is_value_cell(27, 1))
        test.assert_true(stats_layout.is_value_cell(27, 2))
        test.assert_true(stats_layout.is_value_cell(33, 8))
        test.assert_false(stats_layout.is_value_cell(34, 2))
        test.assert_false(stats_layout.is_value_cell(26, 2))
    end)

    test.case('UI layout: stats labels exclude their values', function()
        test.assert_true(stats_layout.is_label_cell(2, 0))
        test.assert_true(stats_layout.is_label_cell(26, 5))
        test.assert_false(stats_layout.is_label_cell(27, 0))
    end)
end
