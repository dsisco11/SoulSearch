...
return function(test, repo_root)
    ...
    test.case('UI layout: stats header boundaries are exact', function()
        test.assert_nil(layout.get_stats_header_column(1, 0))
        test.assert_equal('label', layout.get_stats_header_column(2, 0))
        test.assert_equal('label', layout.get_stats_header_column(25, 0))
