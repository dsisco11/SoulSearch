...
return function(test, repo_root)
    ...
    test.case('UI layout: baseline panel geometry is exact', function()
        ...
        test.assert_equal('unit_id', layout.get_result_header_column(36, 0))
        test.assert_equal('profession', layout.get_result_header_column(46, 0))
    ...
    test.case('UI layout: race control extends the filter panel in order', function()
        ...
        test.assert_equal(8, layout.get_frame('clear_filters').t)
        test.assert_equal(9, layout.get_frame('presets').t)
        test.assert_equal(11, layout.get_frame('filter_list').t)
    end)
